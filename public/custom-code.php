...
function subscription_form( $attrs, $content = null ) {
	...
	$form_html = '<form id="sendgrid_mc_email_form__about" class="mc_email_form" action="#sendgrid_mc_email_subscribe" method="post">'.
		...
		'<div class="search-form"><input id="sendgrid_mc_email" class="search-field" name="sendgrid_mc_email" required="" type="text" value="" placeholder="phil@tecmo.com"><button type="submit" class="search-submit"><svg class="icon icon-envelope-o" aria-hidden="true" role="img"> <use href="#icon-envelope-o" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-envelope-o"></use> </svg><span class="screen-reader-text">Get Access</span></button></div>'.
	'</form>';
